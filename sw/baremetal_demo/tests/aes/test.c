...
int main(void)
{
    ...
    swerv_printf("\nTesting AES128\n\n\r");
#else
    swerv_printf("You need to specify a symbol between AES128, AES192 or AES256. Exiting");
    return 0;
#endif
#endif
...
static void test_encrypt_ecb_verbose(void)
{
    ...
    swerv_printf("ECB encrypt verbose:\n\n\r");
    swerv_printf("plain text:\n\r");
